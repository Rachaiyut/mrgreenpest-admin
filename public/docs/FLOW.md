...
| คำศัพท์ | ความหมาย |
|---|---|
| **ใบประเมิน (Assessment)** | เอกสารที่เซลส์/ช่างกรอกหลังออกสำรวจหน้างาน บันทึกว่าลูกค้ามีปัญหาศัตรูพืชชนิดใด พื้นที่เท่าไหร่ ราคาเท่าไหร่ |
...
| **เซลส์** | พนักงานขาย ไปเสนอราคาลูกค้า ติดตามต่อสัญญา |
...
flowchart LR
    ...
    L12 -->|ใช่| L8
    L12 -->|ครบสัญญา| L13[เซลส์ติดตาม<br/>ต่อสัญญา]
    L13 --> L5
...
flowchart TD
    ...
    Sup --> Sales[เซลส์<br/>ฝ่ายขาย]
    Sup --> Lead[LEAD_TECH<br/>หัวหน้าทีมช่าง]
    Lead --> Tech[TECH<br/>ช่างภาคสนาม]
...
| Field | LEAD_TECH | 3-8 | หัวหน้าทีม |
| Field | TECH | 10-30 | ช่าง |
| Sales | เซลส์ | 2-5 | นักขาย |
...
10:00 — ประชุมกับเซลส์ (ถ้ามีดีลใหญ่)
        หรือ พบลูกค้าสำคัญ
...
**กรณีที่ 1:** เซลส์เสนอราคาให้ลูกค้ารายใหญ่ (เครือโรงงาน) 1,000,000 บาท แต่ลูกค้าขอลด 30% → ราคาต่ำกว่ามาตรฐานมาก
...
→ CEO เรียกประชุม COO + CFO + Sales Manager
→ ตัดสินใจปรับกลยุทธ์: ลด discount นโยบาย, เพิ่มเซลส์อีก 2 คน
...
13:30 — ประชุมกับ Sales Manager (รายดีลที่ติด)
...
1. **รับลูกค้าเข้า**
   ...
   - นัดวันสำรวจ → จ่ายให้เซลส์
2. **ออกเอกสาร**
   - ใบเสนอราคา (จากที่เซลส์ทำใบประเมิน)
   - สัญญา (ถ้าเซลส์ไม่ได้ทำเอง)
   - ใบแจ้งหนี้
...
09:30 — เริ่มทำเอกสารใบเสนอราคา/สัญญาที่ค้าง
        (จากที่เซลส์ทำใบประเมินเมื่อวาน)
...
- ❌ ไม่ลดราคาเอง (ต้องผ่านเซลส์/SUPERADMIN)
...
→ นัดวันสำรวจ
→ จ่ายงานให้เซลส์ทาง LINE Group ของออฟฟิศ
...
#### ภาพรวม
เซลส์คือ**คนที่ทำให้บริษัทมีรายได้** ออกไปเสนอราคาลูกค้า ปิดดีล รักษาความสัมพันธ์ ติดตามต่อสัญญา

#### คุณสมบัติ
- พูดเก่ง บุคลิกดี
- เข้าใจสารเคมีและบริการพื้นฐาน (รู้ว่าปลวกใช้น้ำยาไหน)
- ขับรถเป็น (ขับไปหาลูกค้า)
- ทนงานหนัก (ออกไปนอกออฟฟิศ 70% ของวัน)
- กระตือรือร้น

#### หน้าที่หลัก
1. **ออกไปสำรวจหน้างาน**
   - ไปบ้านลูกค้า/สถานประกอบการ
   - ดูพื้นที่ ถ่ายรูป วัดขนาด
   - คุยกับลูกค้าเรื่องปัญหา
2. **ออกใบประเมิน**
   - กรอกข้อมูลพื้นที่ทั้งหมด
   - คำนวณราคา (ตามแพ็กเกจ + ขนาดพื้นที่)
   - เสนอแผนการชำระเงิน
3. **ทำใบเสนอราคา**
   - ต่อจากใบประเมิน (คัดลอกข้อมูล)
   - ปรับให้ดูเป็นทางการ
   - ส่งให้ Admin ตรวจก่อนออก
4. **ติดตามลูกค้า**
   - โทรหลังส่งใบเสนอราคา (3 วัน)
   - ตอบคำถาม/ข้อสงสัย
   - บันทึก Follow-up
5. **ปิดดีล**
   - ให้ลูกค้าเซ็นเอกสาร (ออนไลน์/หน้างาน)
   - ส่งต่อให้ Admin ทำสัญญา
6. **ต่อสัญญา**
   - ตามลูกค้าที่สัญญาใกล้หมด (90 วันก่อน)
   - เสนอราคาใหม่
   - เจรจาราคา

#### งานประจำวัน
```
08:00 — เช็ค LINE Group ออฟฟิศ — งานใหม่ที่ต้องไปสำรวจ
08:30 — ตรวจตารางวันนี้
        - 10:00 — ไปสำรวจที่บ้านคุณ A
        - 14:00 — ไปสำรวจโรงงาน B
        - 16:00 — กลับออฟฟิศทำเอกสาร
09:00 — ออกเดินทาง
09:30-11:30 — สำรวจหน้างาน (ดู, ถ่ายรูป, คุยลูกค้า)
11:30 — กรอกใบประเมินในแอป (ในรถ หรือร้านกาแฟ)
12:00 — พักเที่ยง
13:00 — เดินทางไปลูกค้าที่ 2
14:00-15:30 — สำรวจ + กรอกใบประเมิน
15:30 — เดินทางกลับออฟฟิศ
16:00 — ทำใบเสนอราคา (จากใบประเมินที่กรอก)
        - ใส่หัวข้อ
        - ใส่หมายเหตุ
        - แนบเอกสาร
        - ส่ง Admin ตรวจ
16:30 — โทรติดตามลูกค้า (3-5 รายที่ส่งใบเสนอราคาไปแล้ว)
        - บันทึก Follow-up
17:00 — เคลียร์งาน — เช็คว่ามี Notification อะไรค้าง
17:30 — กลับบ้าน
```

#### งานประจำสัปดาห์
- **จันทร์:** ประชุมกับ Sales Manager ดูเป้า + Pipeline
- **ทุกวัน:** อัปเดต Pipeline (ใบเสนอราคาที่ส่งไป → กี่ใบปิดได้)
- **ศุกร์:** Wrap-up — ดีลที่เหลือต่อสัปดาห์หน้า

#### งานประจำเดือน
- ดู Sales Pipeline Report — ปิดได้กี่ดีล
- รับเป้าใหม่จาก Sales Manager
- ดูค่าคอมมิชชั่น

#### อำนาจตัดสินใจ
- ✅ ตัดสินใจราคาในช่วงที่กำหนด (มีตารางราคามาตรฐาน)
- ✅ ลดราคาเล็กน้อย (เช่น 5-10%) ได้เอง
- ❌ ลดราคาเยอะ — ต้องส่งขออนุมัติ (ระบบจะ flag)
- ✅ เปลี่ยนแผนงวด/วิธีชำระ (ในขอบเขต)
...
| แก้ไขใบประเมินที่อนุมัติแล้ว | ❌ |
| ออกใบแจ้งหนี้ | ❌ (Admin) |

#### หน้าจอที่ใช้บ่อย
- **Assessments** — Kanban Board ดูใบประเมินตามสถานะ
- **Quotations** — รายการใบเสนอราคา + Pipeline
- **Customers** — ข้อมูลลูกค้า
- **Reports → Sales Pipeline** — ดูตัวเอง
- **Notifications** — ลูกค้าเซ็นแล้ว

#### KPI / ตัวชี้วัด
- จำนวนใบเสนอราคาออกต่อเดือน
- อัตราการปิดดีล (Conversion Rate)
- ยอดขายรวมต่อเดือน
- จำนวนลูกค้าใหม่ที่เซ็นสัญญา
- จำนวนการต่อสัญญา (Renewal)
- ความพึงพอใจลูกค้า (จาก Service Report)

#### ข้อห้าม
- ❌ ไม่รับเงินจากลูกค้าโดยตรง (ให้ลูกค้าโอนตรงเข้าบัญชี)
- ❌ ไม่ลดราคาเกินขอบเขต
- ❌ ไม่สัญญาเพิ่มเติมนอกเหนือจากที่ระบบบันทึก
- ❌ ไม่ส่งเอกสารแทน Admin (Admin ต้องตรวจก่อน)

#### ตัวอย่างสถานการณ์จริง
**กรณีที่ 1 (ปิดดีลปกติ):** ลูกค้า A ขอกำจัดปลวกบ้าน
→ พี่บอยไปสำรวจ → กรอกใบประเมิน 36,000
→ ออกใบเสนอราคา → Admin ตรวจ → ส่งให้ลูกค้า
→ ลูกค้าเซ็นวันที่ 3 หลังส่ง
→ ปิดดีลสำเร็จ → ได้คอมฯ

**กรณีที่ 2 (ดีลใหญ่ราคาต่ำ):** ลูกค้าโรงงาน B ต้องการสัญญารายปี 800,000 บาท แต่ขอลด 25% = 600,000
→ พี่บอยใส่ราคา 600,000 ในใบประเมิน
→ ระบบ flag "ราคาต่ำกว่ามาตรฐาน 25%"
→ ส่งขออนุมัติ COO/CEO
→ COO ดูแล้ว — ปกติบริษัทอยากเข้าตลาดโรงงาน → อนุมัติ
→ พี่บอยทำใบเสนอราคา → ส่งลูกค้า

**กรณีที่ 3 (ลูกค้าตัดสินใจช้า):** ส่งใบเสนอราคาไปแล้ว 7 วัน ลูกค้าไม่ตอบ
→ ระบบแจ้งเตือนพี่บอยว่า "ต้อง Follow-up"
→ พี่บอยโทร — ลูกค้าบอก "งบไม่พอ"
→ บันทึก Follow-up: "ลูกค้าขอเวลา 2 สัปดาห์รอเงินเดือน"
→ ตั้ง Follow-up ครั้งต่อไป 2 สัปดาห์ข้างหน้า

**กรณีที่ 4 (ต่อสัญญา):** สัญญาคุณ A เหลือ 90 วัน
→ ระบบแจ้งพี่บอย
→ พี่บอยโทร — ลูกค้าตกลงต่อ + ขอลด 10%
→ พี่บอยทำใบเสนอราคาใหม่ (ลด 10% ปกติได้)
→ ส่ง → ลูกค้าเซ็น → ต่อสัญญาสำเร็จ

---

### 2.9 LEAD_TECH (หัวหน้าทีมช่าง)

#### ภาพรวม
LEAD_TECH คือ**หัวหน้าทีมช่าง** ดูแลทีม 3-5 คน รับผิดชอบงานทั้งหมดในวัน มอบหมายงาน, แก้ปัญหาเฉพาะหน้า, ยืนยันงานเสร็จ, ปิดงานรายวัน
...
### 2.10 TECH (ช่างภาคสนาม)

#### ภาพรวม
TECH คือ**คนทำงานจริง** ไปบ้านลูกค้า ฉีดยา วางเหยื่อ ติดตั้งสถานี ทำให้ลูกค้าพอใจ บริษัทมีรายได้
...
→ LEAD_TECH ติดต่อ เซลส์/Admin → ออกใบเสนอราคาเพิ่มเติม
→ ลูกค้าเซ็น → ทำต่อ
...
- Admin/Sales ส่งลิงก์ทาง LINE/Email/SMS
...
#### ตัวอย่างสถานการณ์จริง
**กรณีที่ 1 (เซ็นใบเสนอราคา):** เซลส์ส่งลิงก์ทาง LINE
...
flowchart LR
    ...
    subgraph SALES_grp[SALES]
        F1[ใบประเมิน/<br/>ใบเสนอราคา]
        F2[ลดราคาเล็กน้อย]
        F3[Follow-up]
    end
    ...
    style SALES_grp fill:#10b981,color:#fff
...
| Action | CEO | COO | CFO | SUPER | ADMIN | SALES | LEAD | TECH |
|---|---|---|---|---|---|---|---|---|
| ดู Dashboard | ✅ | ✅ | ✅ | ✅ | ✅ | partial | partial | own jobs |
| สร้างลูกค้า | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
| ออกใบประเมิน | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ |
...
4. **Field Tech ไม่ตัดสินใจราคา** — งานเพิ่ม ลด ต้องผ่านเซลส์/แอดมิน
...
```mermaid
flowchart TD
    Day[วันสำรวจ] --> Arrive[เซลส์ไปถึงบ้านลูกค้า]
...
```mermaid
flowchart TD
    Save[เซลส์บันทึกใบประเมิน] --> Compare[ระบบเทียบราคา<br/>กับแพ็กเกจมาตรฐาน]
    ...
    Decision -->|ไม่อนุมัติ| Reject[เซลส์ปรับราคาใหม่]
    Reject --> Save
...
- ป้องกันเซลส์ลดราคาให้ลูกค้ามากเกินไปจนบริษัทขาดทุน
...
#### การติดตาม
- **จำนวนครั้งติดตาม** — เช่น เซลส์โทรไปติดตาม 3 ครั้งแล้ว
...
flowchart LR
    ...
    Send -->|กระดาษ| Paper[เซลส์ไปส่งเอง]
...
- เซลส์พิมพ์ใบเสนอราคา
- ไปให้ลูกค้าเซ็นปากกาที่บ้าน
- เซลส์ถ่ายรูปกลับมาอัปโหลด
...
flowchart LR
    ...
    Auto --> Notify[แจ้งเตือนเซลส์/แอดมิน]
...
gantt
    ...
    แจ้งเซลส์ Contract       :b1, 08:00, 30m
...
flowchart TD
    ...
    Day3 -->|ใช่| Call1[เซลส์โทรครั้งที่ 1<br/>follow_up_count = 1]
    Day3 -->|ตอบแล้ว| Decision[ตกลง/ไม่ตกลง]
    Call1 --> Day7{7 วัน<br/>ยังไม่ตอบ?}
    Day7 -->|ใช่| Call2[เซลส์โทรครั้งที่ 2<br/>follow_up_count = 2]
    Day7 -->|ตอบแล้ว| Decision
    Call2 --> Day14{14 วัน<br/>ยังไม่ตอบ?}
    Day14 -->|ใช่| Call3[เซลส์โทรครั้งที่ 3<br/>follow_up_count = 3]
...
**แต่ละครั้งที่เซลส์ติดตามลูกค้า** ระบบบันทึก:
...
flowchart TD
    ...
    Check -->|ใช่| Notify[แจ้งเซลส์ตอน 08:00]
    Check -->|ไม่| Continue[ทำงานต่อ]

    Notify --> SalesCall[เซลส์โทรลูกค้า]
    ...
    CustDecision -->|ขอลดราคา| Negotiate[เซลส์ต่อรอง]
...
| ใบเสนอราคาอนุมัติแล้ว | เซลส์ผู้สร้าง | รู้ว่าส่งให้ลูกค้าได้ |
| ลูกค้าเซ็นเอกสาร | แอดมิน, เซลส์ | ทำสัญญาต่อ |
| Job ต้องอนุมัติ | SUPERADMIN | อนุมัติ |
| Job เสร็จ | ลูกค้า, เซลส์, แอดมิน | ทราบสถานะ |
...
| สัญญาใกล้หมด (90 วัน) | เซลส์ | ต่อสัญญา |
...
**ใครใช้:** ผู้จัดการเซลส์ → ดูประสิทธิภาพทีมขาย
...
- 10:20 — แอดมินจ่ายงานให้เซลส์ชื่อ "พี่บอย" นัดสำรวจวันที่ 3 พ.ค.
