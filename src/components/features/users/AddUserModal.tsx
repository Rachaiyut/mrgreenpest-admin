...
export const AddUserModal: React.FC<AddUserModalProps> = ({ isOpen, onClose, onCreateUser }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!data['user-national-id'] || !data['user-password'] || !data['user-full-name'] || !data['user-nickname'] || !data['user-role'] || !data['user-phone'] || !imagePreview) {
        ...
        const newUser: Omit<User, 'id' | 'status'> = {
            ...
            creditLimit: data['user-credit-limit'] ? parseFloat(data['user-credit-limit'] as string) : undefined,
        };
        ...
        <Modal
            ...
            footer={
                <div className="flex gap-2">
                    ...
                    <Button type="submit" form="add-user-form" className="py-2 px-4 rounded-lg bg-primary hover:bg-primary/90 text-white font-semibold shadow-sm" variant="primary">
                        บันทึก
                    </Button>
                </div>
            }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-2 space-y-4">
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FormField label="เลขบัตรประชาชน (Username)" htmlFor="user-national-id">
                                <Input id="user-national-id" name="user-national-id" type="text" maxLength={13} required placeholder="13 หลัก" />
                            </FormField>
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FormField label="ชื่อ-นามสกุล" htmlFor="user-full-name">
                                <Input id="user-full-name" name="user-full-name" type="text" required />
                            </FormField>
                            <FormField label="ชื่อเล่น" htmlFor="user-nickname">
                                <Input id="user-nickname" name="user-nickname" type="text" required />
                            </FormField>
                       </div>
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FormField label="เบอร์โทรศัพท์" htmlFor="user-phone">
                             ...
                             <FormField label="อีเมล" htmlFor="user-email">
                                <Input id="user-email" name="user-email" type="email" placeholder="example@email.com" />
                            </FormField>
                       </div>
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <FormField label="จำกัดการเบิก (บาท)" htmlFor="user-credit-limit">
                                <Input id="user-credit-limit" name="user-credit-limit" type="number" placeholder="0.00" step="0.01" />
                            </FormField>
                       </div>
                    </div>
                </div>
