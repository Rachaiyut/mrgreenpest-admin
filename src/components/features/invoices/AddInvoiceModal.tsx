    ...
    useEffect(() => {
        if (selectedContractId && selectedInstallmentTerm) {
            ...
            if (contract) {
                ...
                // Format: InvoiceRunning-ServiceCount-Term (e.g. IV68100-1-1)
                // Middle number is Current Sequence (Term), Last number is Term
                setAutoGeneratedCode(`IVxxxx-${selectedInstallmentTerm}-${selectedInstallmentTerm}`);
            }
        } else {
