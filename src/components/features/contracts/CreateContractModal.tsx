...
export const CreateContractModal: React.FC<CreateContractModalProps> = ({
    ...
    const { customers, handlers } = useData();
            ...
            footer={
                <div className="flex justify-end gap-3 w-full">
                    ...
                    <Button 
                        ...
                        disabled={isSaving}
                    >
                        {isSaving ? 'กำลังบันทึก...' : 'สร้างใบสัญญา'}
                    </Button>
                </div>
            }
        >
            <form id="create-contract-form" onSubmit={handleSubmit} className="space-y-8">
                {/* General Information */}
