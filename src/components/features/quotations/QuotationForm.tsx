  ...
  return (
    ...
    <form id="quotation-form" onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`bg-white rounded-xl border border-slate-200 shadow-sm p-6 col-span-1 lg:col-span-2 ${mode === 'create' && !selectedPackageId && !selectedAssessmentId ? 'opacity-50 pointer-events-none' : ''}`}>
          <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-100">
            ...
            {mode === 'create' && !selectedPackageId && !selectedAssessmentId && (
              <span className="text-sm text-amber-600 bg-amber-50 border border-amber-200 px-3 py-1 rounded-lg">กรุณาเลือกแพ็กเกจหรือใบประเมินก่อน</span>
            )}
          </div>
          <div className="space-y-4">
            {editableAreas
