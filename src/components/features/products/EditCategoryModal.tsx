...
export const EditCategoryModal: React.FC<EditCategoryModalProps> = ({ isOpen, onClose, category, onUpdateCategory, categories }) => {
        ...
        >
            <form id="edit-category-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <FormField label="อักษรย่อ" htmlFor="prefix">
                    <Input name="prefix" id="prefix" type="text" value={formData.prefix || ''} onChange={handleChange} maxLength={3} required />
