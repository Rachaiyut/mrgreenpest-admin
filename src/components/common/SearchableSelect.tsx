      ...
      {isOpen &&
        ...
        createPortal(
          <div
            ref={wrapperRef}
            style={dropdownStyle}
            className="rounded-md bg-white text-base shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none text-sm flex flex-col max-h-80 overflow-hidden min-h-0"
          >
