...
const STATUS_CONFIG: Record<string, { label: string; color: string }> = {
  ...
  PARTIALLY_APPROVED: { label: 'อนุมัติบางส่วน',      color: 'bg-amber-100 text-amber-700' },
  ...
  WAITING_CLEAR:      { label: 'รอเคลียค่าใช้จ่ายและสารเคมี', color: 'bg-orange-100 text-orange-700' },
