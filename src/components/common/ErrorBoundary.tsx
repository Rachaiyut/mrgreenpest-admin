      ...
      return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          ...
          <p className="text-slate-500 mb-4 max-w-md">
            ระบบเกิดข้อผิดพลาดในการแสดงผลหน้านี้ กรุณาลองใหม่อีกครั้ง
          </p>
          <button
            onClick={() => {
          ...
          {this.state.error && (
            <details className="mt-4 text-left text-xs text-slate-400 max-w-lg">
              <summary className="cursor-pointer hover:text-slate-600">รายละเอียดข้อผิดพลาด</summary>
