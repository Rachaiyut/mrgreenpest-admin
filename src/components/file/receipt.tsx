      ...
      >
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ fontSize: 12, marginBottom: 12, lineHeight: 1.4 }}>
            ...
            <div>
              <span style={{ fontWeight: 700 }}>โทร :</span> 02-578-1438 Fax :
              02-578-1439
            </div>
          </div>
          ...
          <div
            style={{ display: 'flex', gap: 12, marginBottom: 4, height: 100 }}
          >
            {/* Customer Box */}
            <div
              style={{
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', gap: 8, width: '45%' }}>
                    ...
                    <div
                      style={{ borderBottom: '1px dotted #ccc', flex: 1 }}
                    ></div>
                  </div>
                  <div style={{ display: 'flex', gap: 8, width: '45%' }}>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <div
                    style={{ borderBottom: '1px dotted #ccc', width: 150 }}
                  ></div>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              >
                ในนาม บริษัท มิสเตอร์กรีน เพสท์ คอนโทรล จำกัด
              </div>
              <div
                style={{
                  borderBottom: '1px dotted #0080ff',
                  marginBottom: 4,
                  width: '90%',
                  alignSelf: 'center',
                }}
