          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
            ...
            <div style={{ width: '60%' }}>
              ...
              <div style={{ fontSize: 12, lineHeight: 1.4, marginBottom: 8 }}>
                <div>สำนักงานใหญ่ : เลขที่ 50/127 ถนนเสนานิคม 1 แขวง/เขตลาดพร้าว กรุงเทพมหานคร 10230</div>
                <div>โทร : 02-578-1438 Fax : 02-578-1439</div>
                <div style={{ marginTop: 4 }}>เลขประจำตัวผู้เสียภาษีอากร : 0 1055 58016 62 0</div>
              </div>
              <img
            ...
            >
              <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>รายงานการเข้าบริการ</div>
              <div style={{ fontSize: 18 }}>Service Report</div>
            </div>
          </div>

          {/* Double Separator Line */}
          <div style={{ borderTop: '1px solid #000', borderBottom: '1px solid #000', height: 4, marginBottom: 24 }}></div>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.8 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 16, marginBottom: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ width: 16, height: 16, border: '1px solid #000', marginRight: 8 }}></div>
                <span>ปลวก</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ width: 16, height: 16, border: '1px solid #000', marginRight: 8 }}></div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
              <div style={{ flex: 1, display: 'flex' }}>
                <span style={{ fontWeight: 700, marginRight: 8, minWidth: 60 }}>เวลาเข้า</span>
                <span style={{ flex: 1, borderBottom: '1px dotted #000', marginRight: 8 }}></span>
                <span style={{ fontWeight: 700 }}>น.</span>
              </div>
              <div style={{ width: 40 }}></div>
              <div style={{ flex: 1, display: 'flex' }}>
                <span style={{ fontWeight: 700, marginRight: 8, minWidth: 60 }}>เวลาออก</span>
                <span style={{ flex: 1, borderBottom: '1px dotted #000', marginRight: 8 }}></span>
                <span style={{ fontWeight: 700 }}>น.</span>
              </div>
            </div>
            ...
            <div style={{ marginBottom: 12 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: 8 }}>
                <div style={{ fontWeight: 700, marginRight: 16, minWidth: 80 }}>การบริการ</div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', paddingLeft: 96 }}>
                <div style={{ width: 16, height: 16, border: '1px solid #000', marginRight: 8 }}></div>
            ...
            <div style={{ marginBottom: 4 }}>
              <div style={{ display: 'flex', marginBottom: 4 }}>
                ...
                <div style={{ width: 16, height: 16, border: '1px solid #000', marginLeft: 8 }}></div>
              </div>
              <div style={{ paddingLeft: 80, marginBottom: 4 }}>
                ...
                <div style={{ borderBottom: '1px dotted #000', height: 24, marginBottom: 4 }}></div>
                <div style={{ borderBottom: '1px dotted #000', height: 24, marginBottom: 4 }}></div>
      ...
      >
        <div style={{ fontSize: 16, lineHeight: 1.8 }}>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <div style={{ borderBottom: '1px dotted #000', height: 24, marginBottom: 8 }}></div>
            <div style={{ borderBottom: '1px dotted #000', height: 24, marginBottom: 24 }}></div>
          </div>
          ...
          <div style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ borderBottom: '1px dotted #000', minWidth: 150, flex: '0 1 auto' }}></span>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start' }}>
              <span style={{ fontWeight: 700, marginRight: 16, minWidth: 100, paddingTop: 4 }}>พนักงานบริการ</span>
              <div style={{ flex: 1 }}>
                 {/* 1 */}
