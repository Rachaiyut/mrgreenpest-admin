    ...
    >
      ...
      >
        <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, lineHeight: 1.4 }}>
                <div>
                  ...
                  (ม.เสนานิเวศน์โครงการ 1) แขวง/เขตลาดพร้าว กรุงเทพฯ 10230
                </div>
          ...
          {/* Divider Line */}
          <div
            style={{ borderBottom: '2px solid #000', marginBottom: 16 }}
          ></div>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.8 }}>
            ...
            <div style={{ marginBottom: 24, border: '1px solid #000' }}>
              ...
              >
                ...
                <div
                  style={{ flex: 1, borderRight: '1px solid #000', padding: 4 }}
                >
                  รายการ
                </div>
                <div
              ...
              {[1, 2, 3].map((i) => (
                ...
                >
                  ...
                  ></div>
                  <div
                    style={{ width: 100, borderRight: '1px solid #000' }}
                  ></div>
            ...
            <div style={{ marginBottom: 30 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                ...
                <span style={{ fontWeight: 700, marginRight: 24 }}>
                  Package
                </span>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 700 }}>
                      Package 1 (เข้าบริการ 7 ครั้ง) สัญญาบริการ 1 ปี
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    ></div>
                    <span style={{ fontWeight: 700 }}>
                      Package 2 (เข้าบริการ 5 ครั้ง) สัญญาบริการ 1 ปี
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    ></div>
                    <span style={{ fontWeight: 700 }}>
                      Package 3 (เข้าบริการ 3 ครั้ง) ไม่รับประกันปลวกมาใหม่
                    </span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    ></div>
                    <span style={{ fontWeight: 700 }}>
                      Package 4 (เข้าบริการ 1 ครั้ง) อัดน้ำยาป้องกัน
                      (กรณีไม่พบปลวกเท่านั้น)
                    </span>
                  </div>
                </div>
              </div>
      ...
      >
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          {/* Divider Line */}
          <div
            style={{ borderBottom: '2px solid #000', marginBottom: 40 }}
          ></div>
          ...
          >
            ...
            <div style={{ width: '40%' }}>
              ...
              >
                <span style={{ marginRight: 8 }}>(</span>
                <div
                  style={{ borderBottom: '1px dotted #000', width: '90%' }}
                ></div>
          ...
          <div style={{ marginTop: 50, paddingLeft: 20, paddingRight: 20 }}>
            ...
            <div
              style={{ border: '1px solid #000', height: 600, width: '100%' }}
            ></div>
          </div>
        </div>
      </div>
