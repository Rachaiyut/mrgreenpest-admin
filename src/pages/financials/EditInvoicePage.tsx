...
export const EditInvoicePage: FC<EditInvoicePageProps> = ({ invoices, customers, quotations, onUpdateInvoice }) => {
    ...
    useEffect(() => {
        ...
        if (found) {
            ...
            setFormData({
                ...found,
                issuedAt: found.issuedAt ? new Date(found.issuedAt).toISOString().substring(0, 10) : '',
                dueAt: found.dueAt ? new Date(found.dueAt).toISOString().substring(0, 10) : '',
            });
        } else if (id) {
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-6 border border-slate-200">
                <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t">
                        <Button type="button" onClick={() => navigate('/billing')} className="py-2 px-6" variant="outline">
                            ยกเลิก
                        </Button>
