        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider sticky left-0 bg-slate-50 z-10 w-24">
                  วันที่
                </th>
                ...
                <th className="px-4 py-3 text-right text-xs font-bold text-green-600 uppercase tracking-wider">
                  รายรับ
                </th>
                ...
                <th className="px-4 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider pl-8">
                  กระเป๋าเงิน
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-200">
              {processedData.length > 0 ? (
                processedData.map((row) => (
                  ...
                  >
                    <td className="px-4 py-3 text-sm text-slate-900 sticky left-0 bg-white font-medium">
                      {row.date}
                    </td>
